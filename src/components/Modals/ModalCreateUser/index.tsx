...
export function ModalCreateUser({
  ...
  const [selectedUserType, setSelectedUserType] = useState<"patient" | "admin">(
    userType
  );
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const response = await userService.createPatientByAdmin(
        userData,
      ...
      if (response.status === 201 || response.status === 200) {
        ...
        if (selectedUserType === "admin") {
          try {
            ...
            await userService.updateUserToAdmin(
              response.data.id,
              userAccountData.access_token
            );
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <select
                ...
                onChange={(e) =>
                  setSelectedUserType(e.target.value as "patient" | "admin")
                }
